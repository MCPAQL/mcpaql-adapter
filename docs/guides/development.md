...
5. Enforce security policies (see [Gatekeeper](https://github.com/MCPAQL/spec/blob/develop/docs/security/gatekeeper.md))
...
- [CRUDE Pattern](https://github.com/MCPAQL/spec/blob/develop/docs/crude-pattern.md)
