...
See [Introspection Specification](https://github.com/MCPAQL/spec/blob/develop/docs/introspection.md) for detailed specification.
...
See [Security Model](https://github.com/MCPAQL/spec/blob/develop/docs/security/gatekeeper.md) for detailed specification.
...
- [CRUDE Pattern Specification](https://github.com/MCPAQL/spec/blob/develop/docs/crude-pattern.md)
- [Introspection Specification](https://github.com/MCPAQL/spec/blob/develop/docs/introspection.md)
- [Operations Guide](https://github.com/MCPAQL/spec/blob/develop/docs/operations.md)
