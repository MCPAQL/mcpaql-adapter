...
**Moved from:** [MCPAQL/spec](https://github.com/MCPAQL/spec) (formerly `docs/architecture/schema-driven-dispatch.md`)

> **Note:** This document describes an **implementation pattern** for adapter dispatch. For normative protocol specifications, see the [spec repository](https://github.com/MCPAQL/spec).
